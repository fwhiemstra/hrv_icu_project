...
def peakprominence(r_peaks, dataframe, ecg_filtered, sampling_rate):
    ...
    r_peaks_prom_2x85, _ = scipy.signal.find_peaks(ecg_filtered,prominence=(2*prominence_85))
    r_peaks_prom_2x85 = r_peaks_prom_2x85 * 1/sampling_rate
    
    r_peak_verified = []
    for element in r_peaks:
        if element in r_peaks_prom_2x85:
